...
let storage = storages.create('ZFBTOOL')
                ...
                <frame>
                    <vertical>
                        <horizontal>
                            ...
                            <input id="服务器IP" w="160"></input>
                            <text text="端口:" textColor="black" textSize="16sp" />
                            <input id="端口" text="" w="90" ></input>
                        </horizontal>
                        <horizontal>
                            <text text="本机编号:" textColor="black" textSize="16sp" />
                            <text id="本机编号" w="40" text={本机编号} textColor="black" textSize="16sp"> </text>
                        </horizontal>
                        <horizontal>
                            <text text="WX端编号:" textColor="black" textSize="16sp" />
                            <input id="WX端编号" w="40"> </input>
                        </horizontal>
